          ...
          <div className="flex items-center justify-center min-h-screen p-4">
            <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
              <div className="sticky top-0 bg-white border-b border-gray-200 px-8 py-6 flex items-center justify-between z-10">
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900">Add Your Property</h2>
                  <p className="text-base text-gray-600 mt-1">Step {currentStep} of 3</p>
                </div>
                      ...
                      {getAllPossibleFeatures().map(feature => (
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            `}>
                              {formData.features.includes(feature) && (
                                <span className="text-[#083A85] text-base">✓</span>
                              )}
                            </div>
                        ...
                        <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-base font-medium text-red-700 mt-1">
                        ...
                        <div className={`border-2 rounded-xl p-6 transition-all ${
                          ...
                          <div className="flex items-center justify-between mb-4">
                            <h4 className="text-lg font-medium text-gray-900">
                              3D Property Video
                              {!formData.video3D && (
                                <span className="ml-2 text-base text-red-600">*Required</span>
                              )}
                            </h4>
                            {formData.video3D && (
                              <span className="text-base text-green-600 font-medium">✓ Uploaded</span>
                            )}
                          </div>
                          ...
                          {!formData.video3D ? (
                            <div>
                              ...
                              >
                                ...
                                <span className="text-base font-medium text-gray-700">Click to upload 3D video</span>
                                <span className="text-base text-gray-500 mt-1">MP4, WebM, MOV, AVI (Max 500MB)</span>
                              </button>
                              <input
                                ref={videoInputRef}
                                type="file"
                            ...
                            <div className="bg-white rounded-lg p-4">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div>
                                    <p className="text-base font-medium text-gray-900">{formData.video3D.name}</p>
                                    <p className="text-base text-gray-500">{formatFileSize(formData.video3D.size)}</p>
                                  </div>
                                </div>
                                <button
                                  type="button"
                              ...
                              {videoUploadProgress > 0 && videoUploadProgress < 100 && (
                                <div className="mt-3">
                                  ...
                                  <p className="text-base text-gray-500 mt-1">Uploading... {videoUploadProgress}%</p>
                                </div>
                              )}
                            </div>
                          )}
                              ...
                              >
                                <div className="flex items-center justify-between mb-3">
                                  <h5 className="font-medium text-gray-900">
                                    {category.label}
                                    {isIncomplete && (
                                      <span className="ml-2 text-base text-amber-600">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                  ...
                                  {formData.images[category.name].length < category.maxImages && (
                                    ...
                                    >
                                      ...
                                      <span className={`text-base ${isIncomplete ? 'text-amber-600' : 'text-gray-500'}`}>
                                        Upload
                                      </span>
                                    </button>
                                  )}
