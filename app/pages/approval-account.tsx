...
const AwaitingApprovalPage = () => {
  ...
  const AnimatedIcon = () => (
    <div className="relative">
      <div className="w-16 h-16 mx-auto mb-3 flex items-center justify-center rounded-full bg-pink-100 text-pink-600 shadow-lg transform transition-transform hover:scale-105">
        <div className="relative">
          {/* Clock icon SVG */}
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 animate-pulse">
  ...
  const ProgressStep: FC<ProgressStepProps> = ({ step, currentStep, icon: Icon, title, description }) => (
    <div className={`flex items-start space-x-3 p-2 rounded-lg transition-all duration-500 ${
      step <= currentStep ? 'bg-blue-50 border-l-4 border-blue-800' : 'bg-gray-50 border-l-4 border-gray-200'
    }`}>
      <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-300 ${
        step <= currentStep ? 'bg-blue-800 text-white' : 'bg-gray-300 text-gray-500'
      }`}>
    ...
    <div className="min-h-screen bg-blue-50 p-3">
      ...
      <div className="relative flex items-center justify-center min-h-screen">
        <div className="w-full max-w-md">
          <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-4 border border-white/20">
            ...
            <div className="mb-4">
              <h1 className="text-2xl font-bold text-blue-800 mb-1 animate-fade-in">
                Application Received
              </h1>
              <div className="w-16 h-0.5 bg-pink-600 mx-auto rounded-full"></div>
            </div>
            
            {/* Enhanced informative message */}
            <div className="mb-4">
              <p className="text-sm text-gray-700 mb-2 leading-relaxed">
                Thank you for applying to be an agent with <span className="font-bold text-black">Jambolush</span>. 
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-3 shadow-inner border border-gray-100 mb-4">
              <h2 className="text-lg font-bold text-gray-800 mb-3 flex items-center justify-center">
                {/* Users icon SVG */}
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 mr-2 text-blue-800">
            ...
            <div className="mb-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <h3 className="font-semibold text-blue-900 mb-1 text-sm">Estimated Timeline</h3>
                <p className="text-blue-700 text-xs flex items-center justify-center">
                  {/* Clock icon SVG */}
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 mr-1">
                    <circle cx="12" cy="12" r="10"/>
                    <path d="M12 6v6l4 2"/>
                  </svg>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-3 justify-center items-center">
                <a
                  ...
                  className="group inline-flex items-center px-6 py-3 border border-transparent text-sm font-semibold rounded-full shadow-lg text-white bg-pink-600 hover:bg-pink-700 transform transition-all duration-200 hover:scale-105 hover:shadow-xl"
                >
                  {/* Mail icon SVG */}
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 mr-2 group-hover:animate-bounce">
