...
const SideBar: React.FC = () => {
    ...
    const navigationItems: Record<UserRole, NavigationItem[]> = {
        user: [
            ...
            { label: 'Profile', icon: 'bi-person', path: '/user/profile' },
        ...
        agent: [
            ...
            { label: 'Profile', icon: 'bi-person', path: '/agent/profile' },
        ...
        tourguide: [
            ...
            { label: 'Profile', icon: 'bi-person', path: '/tourguide/profile' },
            ...
            <div className="p-6 border-b border-gray-100">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600">{getRoleDisplayName(sessionRole)} Dashboard</p>
                    </div>
                </div>
            </div>
