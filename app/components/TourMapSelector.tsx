  ...
  const onPlaceChanged = () => {
    if (autocomplete !== null) {
      ...
      if (place.geometry && place.geometry.location) {
        ...
        // Update map center and selected position
        ...
        if (map) {
          ...
          map.setZoom(17); // Zoom in closer when searching
        }
              ...
              >
                ...
                <div className="mb-4">
                    ...
                    >
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#083A85] focus:border-transparent text-sm placeholder-gray-400"
                  ...
                  <p className="mt-2 text-xs text-gray-500 flex items-center">
                    ...
                    Search for nearby places or click directly on the map
                  </p>
                </div>
